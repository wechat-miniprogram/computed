...
const tscProject = tsc.createProject(path.resolve(config.srcPath, "../tsconfig.json"))
...
class BuildTask {
    ...
    init() {
       ...
       */
         ...
         * 构建相关任务
         */
        gulp.task(`${id}-build`, gulp.series(`${id}-clean-dist`, `${id}-component-check`, gulp.parallel(`${id}-component-wxml`, `${id}-component-wxss`, `${id}-component-ts`, `${id}-component-json`, `${id}-copy`), `${id}-dts`,))
