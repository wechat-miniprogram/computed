  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        if (actions instanceof Array) {
          ...
          Object.keys(actions).forEach(function (field) {
            ...
            if (typeof field !== 'string' && typeof field !== 'number') {
              throw new Error(
                '[mobx-miniprogram] unrecognized field definition',
              )
            }
            methods[field] = function () {
      ...
      function _createDataFieldsReactions(target, options) {
        ...
        var equals = structuralComparison
          ? _mobxMiniprogram.comparer.structural
          : undefined
        ...
        if (fields instanceof Array) {
          ...
          reactions = fields.map(function (field) {
            return (0, _mobxMiniprogram.reaction)(
              function () {
                return store[field]
              },
              function (value) {
          ...
          (typeof fields === 'undefined' ? 'undefined' : _typeof(fields)) ===
            'object' &&
          fields
        ) {
          // for object-typed fields definition
      ...
      var storeBindingsBehavior = (exports.storeBindingsBehavior = Behavior({
        ...
        attached: function attached() {
          ...
          if (Array.isArray(storeBindings)) {
            ...
            this._mobxMiniprogramBindings = _createDataFieldsReactions(
              this,
              storeBindings,
            )
